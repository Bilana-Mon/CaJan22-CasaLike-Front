<template>
    <div class="amenities-preview-container" v-if="stay">
                ...
                <div class="amenity-container">
                    ...
                    <ul class="amenity">
                        <li class="clean-list" v-if="isTV">
                            ...
                            <div class="icons-amen">TV<div>
                        </li>
                        <li class="clean-list" v-if="isEssentials">
                            <svg
                                viewBox="0 0 32 32"
                                xmlns="http://www.w3.org/2000/svg"
                                aria-hidden="true"
                            ...
                            <div class="icons-amen">Essentials<div>
                        </li>
                        <li class="clean-list" v-if="isWifi">
                            <svg
                                viewBox="0 0 32 32"
                                xmlns="http://www.w3.org/2000/svg"
                                aria-hidden="true"
                            ...
                            <div class="icons-amen">Wifi<div>
                        </li>
                        <li class="clean-list" v-if="isKitchen">
                            <svg
                                viewBox="0 0 32 32"
                                xmlns="http://www.w3.org/2000/svg"
                                aria-hidden="true"
                            ...
                            <div class="icons-amen">Kitchen<div>
                        </li>
                        <li class="clean-list" v-if="isBathtub">
                            <svg
                                viewBox="0 0 32 32"
                                xmlns="http://www.w3.org/2000/svg"
                                aria-hidden="true"
                            ...
                            <div class="icons-amen">Bathtub<div>
                        </li>
                        <li class="clean-list" v-if="isWasher">
                            <svg
                                viewBox="0 0 32 32"
                                xmlns="http://www.w3.org/2000/svg"
                                aria-hidden="true"
                            ...
                            <div class="icons-amen">Washer<div>
                        </li>
                        <li class="clean-list" v-if="isDryer">
                            <svg
                                viewBox="0 0 32 32"
                                xmlns="http://www.w3.org/2000/svg"
                                aria-hidden="true"
                            ...
                            <div class="icons-amen">Dryer<div>
                        </li>
                        <li class="clean-list" v-if="isHeating">
                            <svg
                                viewBox="0 0 32 32"
                                xmlns="http://www.w3.org/2000/svg"
                                aria-hidden="true"
                            ...
                            <div class="icons-amen">Heating<div>
                        </li>
                        <li class="clean-list" v-if="isIron">
                            <svg
                                viewBox="0 0 32 32"
                                xmlns="http://www.w3.org/2000/svg"
                                aria-hidden="true"
