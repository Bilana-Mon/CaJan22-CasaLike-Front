<template>
  <section class="review-preview">
       <div class="chart-rating">
           ...
           <span class="stay-details-rate">{{ getFormattedRate }} ·
          <a class="" href="#">{{ stay.numOfReviews }} reviews</a></span>
       </div>
  ...
  <div class="review-preview-container">
    <ul>
        <li v-for="review in stay.reviews.slice(0,6)" :key="review">
         ...
         <div class="show-more"> Show more <svg viewBox="0 0 18 18" role="presentation" aria-hidden="true" focusable="false" style="height: 12px; width: 12px; display: block; fill: var(--f-k-smk-x);"><path d="m4.29 1.71a1 1 0 1 1 1.42-1.41l8 8a1 1 0 0 1 0 1.41l-8 8a1 1 0 1 1 -1.42-1.41l7.29-7.29z" fill-rule="evenodd"></path></svg></div>
        </li>
    </ul>
